items = []
while True:
    print(">>>>>>>  Welcome to Dark Web Market  <<<<<<<<")

    name = input("Enter your username: ")
    password = input("Enter your Darkword: ")
    ...
    if password != name :
        ...
        print(f"Welcome Dark-user {name}")    
    print('================>>> Dark Web market <<<================')
    ...
    if choice == '1' :
        ...
        while len(items) != 0:
            print('Here are all the items available in the market.')
            for item in items:
